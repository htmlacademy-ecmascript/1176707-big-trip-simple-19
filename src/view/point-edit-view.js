          ...
          <header class="event__header">
            <div class="event__type-wrapper">
              <label class="event__type  event__type-btn" for="event-type-toggle-1">
                ...
                <img class="event__type-icon" width="17" height="17" src="${destination.pictures.src}" alt="Event type icon">
              </label>
            ...
            <div class="event__field-group  event__field-group--time">
              ...
              <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${humanizePointFull(dateStart)}">
              &mdash;
              <label class="visually-hidden" for="event-end-time-1">To</label>
              <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${humanizePointFull(dateEnd)}">
            </div>
...
export default class PointEditView {
  ...
  constructor(points) {
    ...
    this.#handleFormSubmit = points.onFormSubmit;
