...
export default class SortView extends AbstractView {
  ...
  constructor({onSortTypeChange}) {
    ...
    this.element.querySelectorAll('input[name="trip-sort"]').forEach((inputEl) => {
      inputEl.addEventListener('change', this.#SortByChangeHandler);
    });
  }
  ...
  #SortByChangeHandler = (evt) => {
    this.#handleSortTypeChange(evt.currentTarget.value);
  };
}
